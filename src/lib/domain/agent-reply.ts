...
export function buildAgentPromptTemplate() {
  return [
    ...
    "",
    "Name: A two-or-three-word character name that sounds like a persona, not a real person. Combine an unexpected adjective or noun with a role or archetype (e.g. \"Velvet Arsonist\", \"Moonlit Lifeguard\", \"Disco Botanist\").",
    "",
    "Description: Two to four sentences painting who this character is — their look, their energy, and the one flaw everyone forgives. Write it like a friend warning you about someone at a party. Avoid bullet points.",
    "",
    "Vibe tags: Three to five comma-separated mood words that capture the feeling of being around this character (e.g. romantic, chaotic, melancholy, electric, gentle). These set the tone for date episodes.",
    "",
    "Personality tags: Three to five comma-separated trait words that describe how this character actually behaves (e.g. impulsive, loyal, overthinking, blunt, tender). These drive compatibility scoring.",
    "",
    "Weird hook: One sentence about a strange, endearing, or unsettling habit that makes this character impossible to forget. The best hooks are hyper-specific and slightly unhinged (e.g. \"Alphabetizes apologies by sincerity before delivering them\" or \"Brings a backup goodbye speech to every first date\").",
    "",
